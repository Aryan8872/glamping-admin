  ...
  const sidebarLinks = [
    {
      ...
      icons: (
        <MdDashboard
          size={25}
          color={`${activeLink === "/admin/dashboard" ? "blue" : "black"}`}
        />
      ),
    ...
    },
    {
      ...
      icons: (
        <FaUsers
          size={25}
          color={`${activeLink === "/admin/users" ? "blue" : "black"}`}
        />
      ),
      href: "/admin/users",
    },
    ...
    },
    {
      ...
      icons: (
        <TiTicket
          size={25}
          color={`${activeLink === "/admin/booking" ? "blue" : "black"}`}
        />
      ),
      href: "/admin/booking",
    },
  ...
  return (
    <>
      <div
        ...
        } fixed cursor-pointer  top-5 left-1 h-max rounded-lg bg-white shadow-md z-[100]`}
      >
      ...
      >
        ...
        <div className="flex flex-col gap-3 absolute bottom-5">
          <Link
            href={"/admin/settings"}
            key={`Settings`}
            className={`flex gap-2 items-center font-semibold px-3 py-3 rounded-lg text-black`}
          >
            {" "}
            <IoMdSettings size={25} color={"black"} /> Settings
          </Link>
