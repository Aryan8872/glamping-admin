...
export default function TicketTable({ planDatas }: { planDatas: Plan[] }) {
  const animatedComponents = makeAnimated();
  const roleOption: { label: string; value: string }[] = [
    { label: "Admin", value: "Admin" },
    { label: "Customer", value: "Customer" },
  ];
  const statusOption: { label: string; value: string }[] = [
    { label: "All", value: "All" },
      ...
      <div className="w-full flex justify-between  px-5 py-5 bg-white rounded-t-2xl ">
        ...
        <div className="flex gap-3  font-semibold">
          ...
          <div className="flex gap-2 items-center bg-[#F3F4F6] px-3 rounded-lg">
            ...
            <Select
              components={animatedComponents}
              className="!focus:outline-none !border-0 px-2"
      ...
      <table className="w-full table-auto text-left mt-3">
        <thead className="text-gray-700 bg-[#F9FAFB] ">
          <tr>
            ...
            <th className="xl:block hidden px-4 py-2 font-semibold">
              Description
            </th>
            ...
            <th className="md:block hidden px-4 py-2 font-semibold">
              Features
            </th>
        ...
        <tbody>
          {planDatas?.map((plan, index) => (
            ...
            >
              ...
              <td className="xl:block hidden px-4 py-3  text-gray-500 ">
                {plan.description}
              </td>
              ...
              <td className="px-4 md:block hidden py-3 text-gray-500 ">
                {plan.features}
              </td>
