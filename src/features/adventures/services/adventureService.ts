...
export async function getAllAdventures(params: any = {}): Promise<{ data: Adventure[], total: number, page: number, perPage: number }> {
    return await adventureApi.apiGetAllAdventures(params);
}
