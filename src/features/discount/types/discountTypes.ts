...
export const createDiscountSchema = z
    ...
    .refine((data) => data.campId || data.adventureId, {
        message: "You must assign the discount to either a Camp or an Adventure",
        path: ["campId"], // Highlighting campId field for the error
    });
