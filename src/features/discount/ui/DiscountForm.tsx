...
export default function DiscountForm({
  ...
  const handleSubmit = async (values: CreateDiscountDTO) => {
    try {
      ...
      throw error; // Let GenericForm handle field errors if any
    }
  };
  ...
  const fields: FieldConfig<CreateDiscountDTO>[] = useMemo(
    () => [
      ...
      { name: "endsAt", label: "Ends At", type: "date", required: true },
            ...
            <div className="space-y-1">
              ...
              >
                <div className="flex items-center gap-2">
                  {selectedCamp?.image && (
                    <img
                      src={buildImageUrl(selectedCamp.image)}
                      alt=""
              ...
              >
                <div className="flex items-center gap-2">
                  {selectedAdventure?.image && (
                    <img
                      src={buildImageUrl(selectedAdventure.image)}
                      alt=""
                      className="w-6 h-6 rounded object-cover"
                    />
                  )}
